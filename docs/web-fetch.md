...
WebFetch is a Playwright-based web content fetcher that uses a headless Chromium
browser with comprehensive stealth measures to bypass bot detection systems like
Cloudflare. It handles JavaScript-rendered pages, lazy loading, and can prompt
for manual login when blocked.
